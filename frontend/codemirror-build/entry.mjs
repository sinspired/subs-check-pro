...
const configCompletions = [
  ...
  { label: "gc-threshold", type: "property", detail: "主动内存回收阈值", section: "检测参数", isArray: false },
...
const arrayItemCompletions = {
  ...
  "node-type": [
    ...
    { "label": "ssr", "detail": "ShadowsocksR 协议" },
    { "label": "vmess", "detail": "VMess 协议" },
    { "label": "vless", "detail": "VLESS 协议" },
    { "label": "trojan", "detail": "Trojan 协议" },
    { "label": "gost-relay", "detail": "GOST Relay 协议" },
    { "label": "hysteria", "detail": "Hysteria 协议" },
    { "label": "hysteria2", "detail": "Hysteria2 协议" },
    { "label": "tuic", "detail": "TUIC 协议" },
    { "label": "wireguard", "detail": "WireGuard 协议" },
    { "label": "ssh", "detail": "SSH 协议" },
    { "label": "openvpn", "detail": "OpenVPN 协议" },
    { "label": "mieru", "detail": "Mieru 协议" },
    { "label": "anytls", "detail": "AnyTLS 协议" },
